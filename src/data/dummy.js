// Organizations
// `deviceTypes` lists which Embed AIoT device/product categories (see
// src/data/deviceTypes.js) this organization is registered for. Set during
// Organization Registration (Admin > Organizations) and consumed by the
...
// Users
// `deviceTypes` designates which of the parent org's device/product types
...
export const devices = [
  ...
  // Non-EMS device/product types (deviceType field). Devices without a
  // `deviceType` are treated as 'ems' for backward compatibility.
  { id:200, status:'Online', name:'AFL - AQMS Ground Floor',   org:'Ambition',          gateway:'AFL-GW-MAIN',  template:'Embed AIoT AQMS Node', switchOn:true, deviceType:'aqms' },
