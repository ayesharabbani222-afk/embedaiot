...
export default function OrgTemplateTriggers() {
  ...
  const orgTemplates = useMemo(() => deviceTemplates.filter(t => t.org === orgName), [orgName])
  ...
  const handleSave = () => {
    ...
    if (modal === 'add') {
      setData(d => [...d, { id: Date.now(), org: orgName, founder: FOUNDER, updatedAt: now, ...form }])
    } else {
