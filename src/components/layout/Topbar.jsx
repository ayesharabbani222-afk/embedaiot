...
import { Bell, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, LogOut, User, Settings, Search, Sun, Moon, Cpu, Menu } from 'lucide-react'
...
export default function Topbar({ title, onMenuClick }) {
  ...
  const searchItems = useMemo(() => {
    ...
    const pageItems = {
      ...
      org: [
        ...
        { title: 'Users', path: '/org/users', category: 'Pages' },
        ...
        { title: 'AI Analytics - Voltage Imbalance', path: '/org/ai-analytics/voltage-imbalance', category: 'Pages' },
        { title: 'AI Analytics - Current Imbalance', path: '/org/ai-analytics/current-imbalance', category: 'Pages' },
        { title: 'AI Analytics - Power Factor', path: '/org/ai-analytics/power-factor', category: 'Pages' },
        { title: 'AI Analytics - Energy Consumption', path: '/org/ai-analytics/energy-consumption', category: 'Pages' },
        { title: 'AI Analytics - Anomalies', path: '/org/ai-analytics/anomalies', category: 'Pages' },
  ...
  return (
    <header className="h-14 bg-white dark:bg-surface-900 border-b border-surface-200 dark:border-surface-800 flex items-center justify-between px-3 sm:px-6 sticky top-0 z-[100] shadow-sm select-none transition-colors duration-200">
      {/* Title & Breadcrumbs */}
      <div className="min-w-0 flex items-center gap-3">
        <button
          type="button"
          onClick={onMenuClick}
          className="lg:hidden flex-shrink-0 p-1.5 -ml-1 rounded-md text-surface-500 hover:text-surface-900 hover:bg-surface-100 dark:hover:text-surface-100 dark:hover:bg-surface-800 transition-colors"
